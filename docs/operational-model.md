...
|------|--------------------|-------------------|
| **Career** | Persistent, fact-locked career context; delegates only to Researcher and Writer | Reviews delegated work against verified facts; applications, employer contact, publishing, and commitments require approval |
